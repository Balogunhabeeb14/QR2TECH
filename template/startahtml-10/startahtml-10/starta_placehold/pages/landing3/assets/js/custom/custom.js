$(document).ready(function () {
  ...
  $(".animateNumber").each(function () {
    var animateNumber = $(this).text().replace("%", "");
    imgBLock.to($(this).closest(".fill"), {
      width: animateNumber + "%",
      duration: 2,
    });
  });
  ...
  let startaHeadingCounter = gsap.timeline({
    scrollTrigger: {
      trigger: ".starta-project",
      start: "top center",
    },
  });

  startaHeadingCounter.from(".starta-big-h span", {
    textContent: 0,
    duration: 2.5,
    snap: { textContent: 1 },
    // stagger: 1,
